                ...
                switch (match.getMatchType()) {
                    case SOLO:
                        ...
                        str = str
                                ...
                                .replace("{match-solo-boxing-difference-plusless}", (solo_x > solo_y ? CC.GREEN : solo_x == solo_y ? CC.YELLOW : CC.RED) + "(" + soloDifference + ")")
                                .replace("{match-solo-boxing-difference-plusless-bracketless}", (solo_x > solo_y ? CC.GREEN : solo_x == solo_y ? CC.YELLOW : CC.RED) + soloDifference)
                                .replace("{match-solo-boxing-difference-bracketless}", (solo_x > solo_y ? CC.GREEN : solo_x == solo_y ? CC.YELLOW : CC.RED) + (soloDifference > 0 ? "+" : "") + soloDifference)
                    ...
                    case SPLIT:
                        ...
                        str = str
                                ...
                                .replace("{match-team-boxing-difference-plusless}", (teams_x > teams_y ? CC.GREEN : teams_x == teams_y ? CC.YELLOW : CC.RED) + "(" + teamsDifference + ")")
