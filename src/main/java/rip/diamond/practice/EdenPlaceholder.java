                ...
                switch (match.getMatchType()) {
                    ...
                    case SPLIT:
                        ...
                        str = str
                                ...
                                .replace("{match-team-boxing-difference-text}", teamsDifference == 0 ? Language.SCOREBOARD_BOXING_COUNTER_NO_COMBO.toString() : Language.SCOREBOARD_BOXING_COUNTER_TEXT.toString())
