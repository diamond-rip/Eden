                ...
                switch (match.getMatchType()) {
                    case SOLO:
                        ...
                        str = str
                                ...
                                .replace("{match-solo-boxing-difference-text}", soloDifference == 0 ? Language.SCOREBOARD_BOXING_COUNTER_NO_COMBO.toString() : Language.SCOREBOARD_BOXING_COUNTER_TEXT.toString())
                    ...
                    case SPLIT:
                        ...
                        str = str
                                ...
                                .replace("{match-team-boxing-difference-text}", Language.SCOREBOARD_BOXING_COUNTER_TEXT.toString())
                                .replace("{match-team-boxing-difference}",  teamsDifference == 0 ? Language.SCOREBOARD_BOXING_COUNTER_NO_COMBO.toString() : Math.abs(teamsDifference) + "")
