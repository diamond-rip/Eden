...
public class ArenaEditMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(1, new ArenaCloneButton(arena));
        buttons.put(3, new ArenaToggleButton(arena));
        buttons.put(5, new ArenaSaveButton(arena));
        buttons.put(7, new ArenaDeleteButton(arena));
        ...
        buttons.put(22, new ArenaYLimitButton(arena));
        buttons.put(23, new ArenaBuildMaxButton(arena));
        buttons.put(24, new ArenaAllowedKitsButton(arena));
