...
public enum Language {
    ...
    EVENT_SUMO_EVENT_SCOREBOARD_STARTING_EVENT("event.sumo-event.scoreboard.starting-event"),
    EVENT_SUMO_EVENT_SCOREBOARD_STARTING_NEW_ROUND("event.sumo-event.scoreboard.starting-new-round"),
    EVENT_SUMO_EVENT_SCOREBOARD_FIGHTING("event.sumo-event.scoreboard.fighting"),
