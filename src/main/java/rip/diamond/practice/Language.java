...
public enum Language {
    ...
    EVENT_TOURNAMENT_STATUS_STARTING_FIGHTING("event.tournament.status.fighting"),
    EVENT_TOURNAMENT_STATUS_STARTING_FIGHTING_TEAM_FORMAT("event.tournament.status.fighting-team-format"),
    EVENT_TOURNAMENT_NO_WINNER_BECAUSE_NO_PARTY("event.tournament.no-winner-because-no-party"),
    EVENT_TOURNAMENT_WINNER_ANNOUNCE_MESSAGE("event.tournament.winner-announce.message"),
    EVENT_TOURNAMENT_WINNER_ANNOUNCE_SPLIT_FORMAT("event.tournament.winner-announce.split-format"),
    ...
    KIT_GAME_RULES_GOAL_RULES("kit.game-rules.goal.rules"),
    KIT_GAME_RULES_GOAL_DESCRIPTION("kit.game-rules.goal.description"),
